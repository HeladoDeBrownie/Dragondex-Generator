var grammar = tracery.createGrammar({
    ...
    'reproduction': [
        'Its eggs #egg fact#.',
        'Its #body part quality# #body part# #body part is# integral to its reproductive cycle.',
        'Its #mating# #ritual# #fact about mating ritual#.',
    ],
    'egg fact': 'are #egg design# and #egg description#',
    'egg design': [
        'made of #material#',
        'solid #egg color#',
        'speckled #egg color# on #egg color#',
        'striped #egg color# and #egg color#',
        '#egg color# dotted with #egg color# #egg design shapes#',
    ],
    'material': [
        '#egg color# crystal',
        '#egg color# stone',
    ...
    'egg shape': '#degree# #shape descriptor#',
    'elemental description': [
        'coated in venom',
        'constantly on fire',
        'crackling with electricity',
        'dripping wet',
        'saturated with static charge',
    ],
    'degree': [
        'slightly',
        'fairly',
    ...
    'fact about mating ritual': [
        '#focuses on# its #body part quality# #body part#',
        'has never been recorded',
        'takes place in #places#',
    ],
    'focuses on': [
        'centers on',
        'focuses on',
